$(document).ready(function () {
    ...
    function getData() {
        if (!isLoading) {
            ...
            fetch('http://localhost/tobacco/wp-json/wp/v2/research', {
                method: 'post',
                header: {
    ...
    function displayResult(result) {
        ...
        if (length) {
            ...
            result.forEach(val => {
                ...
                date = `${vi_month[date.getMonth()]} ${date.getFullYear()}`;
                html += `
                    <div class="pt-3">
                        <div class="d-flex post-wrapper pt-3">
                            <div class="col-md-8">
                                ...
                                <p><span class="custom-post-excerpt">${val.post_excerpt}</span><a class="more" href="${val.guid}"> Đọc tiếp &raquo;</a>
                            </div>
                            <div class="col-md-4">
                                <div class="date">
                                    ${date}
                                </div>
                                <p class="topic-list"><strong>Chủ đề</strong>: ${terms}
                            </div>
                        </div>
                    </div>
                `
            ...
            html += `
                <p class="no-result my-5 text-center" style="font-size: 2rem; color: #6b635a; border-top: 1px solid #c6c1bb">Không tìm thấy nghiên cứu.</p>
            `;
        }
