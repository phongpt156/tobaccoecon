...
Increase your Twitter followers with Social PopUP Plugin ([http://wordpress.org/extend/plugins/popups/](http://wordpress.org/extend/plugins/popups/))
...
* Changed consumer name to API to match new Twitter settings
* Fixed issue with strict standards
* Now it shows the proper error instead of empty widget
