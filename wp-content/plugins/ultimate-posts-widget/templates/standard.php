            ...
            <div>
              <?php if (get_the_title() && $instance['show_title']) : ?>
                <h4 class="entry-title">
                  <a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?> <span class="entry-readmore">»</span></a>
                </h4>
              <?php endif; ?>
          ...
          <footer>
            ...
            ?>
              <div class="entry-categories">
                <strong class="entry-cats-label"><?php _e('Categories', 'upw'); ?>:</strong> <span class="entry-cats-list"><?php echo $categories; ?></span>
              </div>
            <?php endif; ?>
            ...
            <?php
              $topics = get_the_term_list($post->ID, 'topic', '', ', ');
              $lang = get_bloginfo('language');
              if ($topics):
            ?>
              <div class="entry-tags">
                <strong class="entry-cats-label">
                  <?php switch ($lang): case 'vi': _e('Chủ đề', 'upw'); ?>
                    : </strong><span class="entry-cats-list"><?php echo $topics; ?></span>
                  <?php
                    break;
                    case 'en': _e('Chủ đề', 'upw');
                  ?>
                    : </strong><span class="entry-cats-list"><?php echo $topics; ?></span>
                  <?php break; ?>
              </div>
  ...
  <?php else : ?>
    ...
    ?>
      <p class="upw-not-found">
        <?php _e('Ko tìm thấy bài viết.', 'upw'); ?>
      </p>
    <?php elseif ($lang == 'en_GB'): ?>
